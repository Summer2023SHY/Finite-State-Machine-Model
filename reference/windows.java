...
public class windows {
    ...
    public void test() {
        ...
        FSMToDot.createImgFromFSM(uStruc.getPlantFSM(), ADA_WORKING_FOLDER + "_out1", ADA_WORKING_FOLDER, ADA_CONFIG_FILE_PATH);
        
        FSMToDot.createImgFromFSM(uStruc.getUStructure(), ADA_WORKING_FOLDER + "_out2", ADA_WORKING_FOLDER, ADA_CONFIG_FILE_PATH);
        ...
        File m1 = new File(GenerateFSM.createModalSpec(sizeState, sizeMarked, sizeEvents, sizePaths, sizePrivate, sizeUnobserv, sizeAttacker, sizeControl, sizeMust, "modalSpec1", ADA_WORKING_FOLDER));
        File m2 = new File(GenerateFSM.createModalSpec(sizeState, sizeMarked, sizeEvents, sizePaths, sizePrivate, sizeUnobserv, sizeAttacker, sizeControl, sizeMust, "modalSpec2", ADA_WORKING_FOLDER));
        
        //m1 = new File(ADA_WORKING_FOLDER + "m1.mdl");
        //m2 = new File(ADA_WORKING_FOLDER + "m2.mdl");

        ModalSpecification mod1 = new ModalSpecification(m1, "mod1");
        
        FSMToDot.createImgFromFSM(mod1, ADA_WORKING_FOLDER + "mod1", ADA_WORKING_FOLDER, ADA_CONFIG_FILE_PATH);
        
        /*
        mod1.toTextFile(ADA_WORKING_FOLDER, "cop_1");
        ModalSpecification mod2 = new ModalSpecification(m2, "mod2");
        mod2.toTextFile(ADA_WORKING_FOLDER, "cop_2");
        mod1 = new ModalSpecification(new File(ADA_WORKING_FOLDER + "cop_1.mdl"), "mod1");
        mod2 = new ModalSpecification(new File(ADA_WORKING_FOLDER + "cop_2.mdl"), "mod2");
        
        FSMToDot.createImgFromFSM(mod1, ADA_WORKING_FOLDER + "mod1", ADA_WORKING_FOLDER, ADA_CONFIG_FILE_PATH);
        FSMToDot.createImgFromFSM(mod2, ADA_WORKING_FOLDER + "mod2", ADA_WORKING_FOLDER, ADA_CONFIG_FILE_PATH);
        
        ModalSpecification mod3 = mod1.getGreatestLowerBound(mod2);
        
        FSMToDot.createImgFromFSM(mod3, ADA_WORKING_FOLDER + "mod3", ADA_WORKING_FOLDER, ADA_CONFIG_FILE_PATH);
        
        //FSMToDot.createTikZFromFSM(mod1, ADA_WORKING_FOLDER + "out_test_1", ADA_WORKING_FOLDER, ADA_CONFIG_FILE_PATH);
        //FSMToDot.createImgFromFSM(mod1, ADA_WORKING_FOLDER + "out_test_im_1", ADA_WORKING_FOLDER, ADA_CONFIG_FILE_PATH);
    ...
    /*
        ...
        if(mod3.getTransitions().getTransitions(mod3.getInitialState()).size() > 1) {
            FSMToDot.createImgFromFSM(mod1, ADA_WORKING_FOLDER + "_img_1",  ADA_WORKING_FOLDER, ADA_CONFIG_FILE_PATH);
              FSMToDot.createImgFromFSM(mod2, ADA_WORKING_FOLDER + "_img_2",  ADA_WORKING_FOLDER, ADA_CONFIG_FILE_PATH);
              FSMToDot.createImgFromFSM(mod3, ADA_WORKING_FOLDER + "_img_3",  ADA_WORKING_FOLDER, ADA_CONFIG_FILE_PATH);
        }
    /*
        System.out.println("A");
        File f = new File(GenerateFSM.createNewModalSpecification(10, 4, 3, 2, 1, 2, 3, 1, 2, false, "fileName", ADA_WORKING_FOLDER));
        System.out.println("A");
        DetObsContFSM fsm = new NonDetObsContFSM(f, "fsm").buildObserver();
        System.out.println("A");
        System.out.println(fsm.makeDotString());
        
        FSMToDot.createImgFromFSM(fsm, ADA_WORKING_FOLDER + "test1", ADA_WORKING_FOLDER, ADA_CONFIG_FILE_PATH);
        DetObsContFSM fsm2 = (DetObsContFSM)fsm.makeAccessible();
        System.out.println(fsm2.makeDotString());
        FSMToDot.createImgFromFSM(fsm2, ADA_WORKING_FOLDER + "test2", ADA_WORKING_FOLDER, ADA_CONFIG_FILE_PATH);
        DetObsContFSM fsm3 = (DetObsContFSM)fsm2.makeCoAccessible();
        System.out.println(fsm3.makeDotString());
        FSMToDot.createImgFromFSM(fsm3, ADA_WORKING_FOLDER + "test3", ADA_WORKING_FOLDER, ADA_CONFIG_FILE_PATH);
        
    /*
        FSMToDot.createImgFromFSM(fsm1, ADA_WORKING_FOLDER + "test2", ADA_WORKING_FOLDER, ADA_CONFIG_FILE_PATH);
        DetFSM fsm2 = fsm1.determinize();
        FSMToDot.createImgFromFSM(fsm2, ADA_WORKING_FOLDER + "test3", ADA_WORKING_FOLDER, ADA_CONFIG_FILE_PATH);
        System.out.println(fsm2.makeDotString());
        
        /*NonDetFSM fsm3 = fsm1.union(fsm2);
        FSMToDot.createImgFromFSM(fsm3, ADA_WORKING_FOLDER + "test4", ADA_WORKING_FOLDER, ADA_CONFIG_FILE_PATH);
